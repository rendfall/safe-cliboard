	      ...
	      return new _promise2.default(function (resolve, reject) {
	        ...
	        if (_this._options.renderComposition) {
	          _this._compositionImage.render().then(function (image) {
	            resolve({ differences: differences, threshold: threshold, passed: passed, compositionImage: image });
	          });
	        } else {
	          resolve({ differences: differences, threshold: threshold, passed: passed });
	        }
	      });
	    }
